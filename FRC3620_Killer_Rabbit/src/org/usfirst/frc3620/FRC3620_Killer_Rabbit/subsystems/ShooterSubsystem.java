...
public class ShooterSubsystem extends Subsystem {
    ...
    public void toggleShooter()  //shooter only needs to be lowered when going under low bar
    {
    	if(lowered)
    	{
    		shooterPositionTalon.set(0.35);  //this will start to raise the shooter
    		lowered = false;
    	}
    	else
    	{
    		shooterPositionTalon.set(-0.35); //this will start to lower the shooter
    		lowered = true;
    	}
    }
